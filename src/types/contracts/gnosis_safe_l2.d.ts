...
export type SafeModuleTransaction = ContractEventLog<{
  module: string;
  to: string;
  value: string;
  data: string;
...
export type SafeMultiSigTransaction = ContractEventLog<{
  to: string;
  value: string;
  data: string;
  operation: string;
...
export interface GnosisSafeL2 extends BaseContract {
  ...
  events: {
    ...
    SafeModuleTransaction(cb?: Callback<SafeModuleTransaction>): EventEmitter;
    SafeModuleTransaction(
      options?: EventOptions,
      cb?: Callback<SafeModuleTransaction>
    ): EventEmitter;

    SafeMultiSigTransaction(
      cb?: Callback<SafeMultiSigTransaction>
    ): EventEmitter;
    SafeMultiSigTransaction(
      options?: EventOptions,
      cb?: Callback<SafeMultiSigTransaction>
